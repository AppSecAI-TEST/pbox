...
public class ImageLoader {
    ...
    /**
     * Checks if the layout_card_view_item is available in the cache.
     * @param requestUrl The url of the remote image
     * @param maxWidth The maximum width of the returned image.
     * @param maxHeight The maximum height of the returned image.
     * @return True if the layout_card_view_item exists in cache, false otherwise.
     */
    ...
    private class BatchedImageRequest {
        ...
        /** The result of the request being tracked by this layout_card_view_item */
