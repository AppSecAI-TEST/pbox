 ...
 */
public class ToolsEMSOutEntity {
    ...
    public ArrayList<ToolsResultEntity> generateList() {
        ...
        result.add(new ToolsResultEntity("EMS运费", HomeFreight1, HomeFreight2, HomeFreight3));
    ...
    /**
     ...
     Cost2	采购成本(本币)
     Cost3	采购成本(比例)
     HomeFreight1	小包运费(外币)
     HomeFreight2	小包运费(本币)
     HomeFreight3	小包运费(比例)
     Incidentals1	杂费(外币)
     Incidentals2	杂费(本币)
     Incidentals3	杂费(比例)
     Commission1	平台佣金(外币)
