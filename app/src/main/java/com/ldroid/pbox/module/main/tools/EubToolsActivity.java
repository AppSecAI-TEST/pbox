...
public class EubToolsActivity extends BaseActivity implements  ToolsContract.View{
    ...
    protected void setContentView() {
        setContentView(R.layout.ac_eub_tools);
    }
    ...
    protected void initUI() {
        ...
        initTopBarForBoth("E邮宝", null, getResources().getDrawable(R.drawable.icon_common_back),
                "计算", null);
    ...
    private void reqToolsEYB() {
        ...
        mPresenter.reqToolsEYB(userid, productname, countryname, profitmargin,
    ...
    class Adapter extends CommonAdapter<ToolsResultEntity> {
        ...
        public Adapter() {
            super(EubToolsActivity.this, R.layout.layout_common_tools_item);
        }
