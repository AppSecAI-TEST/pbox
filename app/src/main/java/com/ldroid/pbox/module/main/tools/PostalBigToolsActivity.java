...
public class PostalBigToolsActivity extends BaseActivity implements ToolsContract.View{
    ...
    public void onClickCountry() {
        startAnimActivity(new Intent(mContext, CountryListActivity.class)
                .putExtra(EXTRA_COUNTRY_TYPE, ToolsContract.CountryType.BIG));
    }
    ...
    private void reqToolsGHDB() {
        ...
        mPresenter.reqToolsGHDB(userid, productname, countryname, profitmargin,
